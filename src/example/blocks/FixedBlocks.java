...
public class FixedBlocks{
    ...
    public static void load(){
        ...
        slagCentrifuge = new GenericCrafter("slag-centrifuge"){{
            ...
            Seq<DrawBlock> drawers = Seq.with(new DrawRegion("-bottom"), new DrawLiquidRegion(Liquids.slag){{ alpha = 0.7f; }}); // EDITED
        ...
        lustre = new ContinuousTurret("lustre"){{
            ...
            drawer = new DrawTurret("reinforced-"){{
                PartProgress heatp = PartProgress.warmup.blend(p -> Mathf.absin(2f, 1f) * p.warmup, 0.2f); // EDITED
        ...
        smite = new ItemTurret("smite"){{
            ...
            PartProgress haloProgress = PartProgress.warmup.delay(0.5f); // EDITED
        ...
        malign = new PowerTurret("malign"){{
            ...
            PartProgress haloProgress = PartProgress.warmup; // EDITED
            Color haloColor = Color.valueOf("d370d3"), heatCol = Color.purple;
            float haloY = -15f, haloRotSpeed = 1.5f;

            PartProgress circleProgress = PartProgress.warmup.delay(0.9f); // EDITED
            Color circleColor = haloColor; // EDITED
        ...
        payloadConveyor = new FixedPayloadConveyor("payload-conveyor"){{
            requirements(Category.units, with(Items.graphite, 10, Items.copper, 10));
            canOverdrive = false;
        }};

        payloadRouter = new FixedPayloadRouter("payload-router"){{
            requirements(Category.units, with(Items.graphite, 15, Items.copper, 10));
            canOverdrive = false;
        }};

        reinforcedPayloadConveyor = new FixedPayloadConveyor("reinforced-payload-conveyor"){{
        ...
        reinforcedPayloadRouter = new FixedPayloadRouter("reinforced-payload-router"){{
